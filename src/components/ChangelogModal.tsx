      ...
      <div style={{
        ...
        <div style={{ padding: '40px', overflowY: 'auto', flex: 1 }} className="custom-scrollbar">
          ...
          <VersionBlock version="v2.4.0" date="May 2026" isLatest>
            ...
            <LogItem icon={<Zap size={14} color="#A855F7" />} type="Improved" title="Cyber-Organic UI">
          ...
          <VersionBlock version="v2.2.0" date="March 2026">
            <LogItem icon={<Zap size={14} color="#A855F7" />} type="Improved" title="Complexity Analyzer">
  ...
  <div style={{ position: 'relative', paddingLeft: '40px', marginBottom: '50px' }}>
    ...
    <div style={{ marginBottom: '20px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        {isLatest && <span style={{ fontSize: '0.7rem', padding: '2px 8px', background: 'rgba(124, 58, 237, 0.1)', color: 'var(--landing-accent)', borderRadius: '100px', fontWeight: 800 }}>LATEST</span>}
      </div>
    </div>
