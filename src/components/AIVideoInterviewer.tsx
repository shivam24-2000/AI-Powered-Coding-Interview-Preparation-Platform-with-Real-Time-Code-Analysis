...
export const AIVideoInterviewer: React.FC<AIVideoInterviewerProps> = ({
  ...
  if (isHidden) {
    return (
      ...
      >
        <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#a78bce', boxShadow: '0 0 8px #a78bce' }} />
    ...
    >
      ...
      <style>{`
        ...
        .typing-dot {
          ...
          background: rgba(150,118,200,0.7);
      ...
      <div style={{
        ...
        boxShadow: isSpeaking
          ? '0 24px 60px rgba(0,0,0,0.2), 0 0 40px rgba(150,118,200,0.1)'
          ...
          <>
            ...
            <div style={{ padding: '10px 14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'var(--bg-panel-light)' }}>
              <div style={{ display: 'flex', gap: '8px' }}>
                ...
                <button className="vid-ctrl-btn" onClick={() => setShowTranscript(p => !p)} style={{ background: showTranscript ? 'rgba(150,118,200,0.1)' : 'var(--bg-panel-light)' }} title="Toggle transcript">
