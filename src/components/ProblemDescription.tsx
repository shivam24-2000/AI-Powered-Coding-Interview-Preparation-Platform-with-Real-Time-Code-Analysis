        ...
        <div style={{ display: 'flex', alignItems: 'stretch', gap: '4px' }}>
          <button
            ...
            style={{
              ...
              textShadow: activeTab === 'description' ? '0 0 12px rgba(150, 118, 200, 0.5)' : 'none',
            }}
          >
          ...
          <button
            ...
            style={{
              ...
              fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em',
              height: '100%', marginBottom: '-1px',
              textShadow: activeTab === 'whiteboard' ? '0 0 12px rgba(150, 118, 200, 0.5)' : 'none',
            }}
          >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <button
            ...
            onMouseOver={e => {
              ...
              e.currentTarget.style.background = 'rgba(150, 118, 200, 0.1)';
              e.currentTarget.style.boxShadow = '0 0 15px rgba(150, 118, 200, 0.15)';
            }}
            onMouseOut={e => {
