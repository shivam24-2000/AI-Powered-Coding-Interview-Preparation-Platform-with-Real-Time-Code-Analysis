    ...
    <div style={{
      ...
      <div className="glass-panel" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          ...
          <h3 style={{ margin: 0, color: 'var(--text-primary)', fontSize: '1.2rem', fontWeight: 700 }}>Host Mock Interview</h3>
          <p style={{ margin: '4px 0 0 0', color: 'var(--text-muted)', fontSize: '0.8rem' }}>Share this session link to synchronize code live!</p>
        </div>
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          <div style={{
            padding: '12px', background: 'var(--bg-panel-light)', border: '1px solid var(--border-color)',
            borderRadius: '10px', fontSize: '1.4rem', fontWeight: 800, color: 'var(--accent-primary)',
        ...
        <div>
          <label style={{ fontSize: '0.7rem', color: 'var(--text-muted)', fontWeight: 600, textTransform: 'uppercase' }}>Interviewer Invite Link</label>
          <div style={{
            display: 'flex', gap: '8px', marginTop: '4px',
            background: 'var(--bg-panel-light)', padding: '8px 12px',
            ...
            <input 
              ...
              readOnly 
              value={link} 
              style={{ flex: 1, background: 'transparent', border: 'none', color: 'var(--text-primary)', fontSize: '0.75rem', outline: 'none', textOverflow: 'ellipsis' }}
            />
            <button 
              onClick={handleCopy}
              style={{
