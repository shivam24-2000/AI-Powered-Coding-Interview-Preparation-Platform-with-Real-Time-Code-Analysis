      ...
      <div style={{
        ...
        <div style={{ padding: '40px', overflowY: 'auto', flex: 1 }} className="custom-scrollbar">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }}>
            ...
            <ExamFeature icon={<BarChart2 size={20} color="#a78bce" />} title="Detailed Scorecard">
              Receive a granular breakdown of your Technical Skills, Behavioral Response, and overall Hireability.
            </ExamFeature>

          </div>

          <div style={{ marginTop: '40px', display: 'flex', gap: '20px', padding: '24px', background: 'rgba(150, 118, 200, 0.05)', borderRadius: '20px', border: '1px solid rgba(150, 118, 200, 0.1)' }}>
            <div style={{ padding: '12px', background: 'rgba(150, 118, 200, 0.1)', borderRadius: '14px', height: 'fit-content' }}>
              <ShieldAlert size={24} color="#a78bce" />
            </div>
            <div>
        ...
        <div style={{ padding: '24px 40px', background: 'rgba(0,0,0,0.2)', borderTop: '1px solid var(--landing-border-light)', textAlign: 'right', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <button
            ...
            style={{
              padding: '12px 30px',
              background: 'linear-gradient(135deg, #a78bce, #aa5888)',
              border: 'none',
              borderRadius: '12px',
              color: '#fff',
              fontWeight: 800,
              fontSize: '0.9rem',
              cursor: 'pointer',
              boxShadow: '0 8px 25px rgba(150, 118, 200, 0.3)',
              display: 'flex',
              alignItems: 'center',
              gap: '10px'
            }}
